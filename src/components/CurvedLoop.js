...
const CurvedLoop = ({
  ...
  return (
    ...
    >
      ...
      >
        <text ref={measureRef} xmlSpace="preserve" className={className ?? ''} style={{ visibility: 'hidden', opacity: 0, pointerEvents: 'none', fontSize: '6rem' }}>
          {text}
        </text>
        <defs>
        ...
        {ready && (
          <text xmlSpace="preserve" className={className ?? ''} style={{ fontSize: '6rem' }}>
